...
import ru.nsd.domain.Message;
import ru.nsd.domain.MessageDto;
import ru.nsd.service.DataStore;
...
public class DataController {
    ...
    @GetMapping(value = "/all_messages", produces = MediaType.APPLICATION_NDJSON_VALUE)
